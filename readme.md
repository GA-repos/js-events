...
Go to this
[repository](https://git.generalassemb.ly/Flex-928/event-listener-practice)
...
Visit this
[repository](https://git.generalassemb.ly/Flex-928/color-scheme-switcher)
and follow along!
...
Clone down
[this repository](https://git.generalassemb.ly/Flex-928/js-event-propagation-practice)
...
typically want to do when working with links. Next, the event handler checks the
event target to see if it is a link (i.e. is an <code>a</code> tag). If it is,
an alert is created with the text "You clicked a button".

</details>

**Let's refactor the
[`js-event-propagation`](https://git.generalassemb.ly/Flex-928/js-event-propagation-practice)
